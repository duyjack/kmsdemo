                    ...
                    if (error) {
                        ...
                        return callback(error);
								...
								pipeline.create('ChromaFilter', options, function(error, filter) {
									...
									const appServerUrl = "https://cardmanager-dev.herokuapp.com/static/";
									filter.setBackground(appServerUrl + 'taolao.png', function(error) {
										if (error) return callback(error);
...
function startViewer(sessionId, ws, sdpOffer, callback) {
	...
	presenter.pipeline.create('WebRtcEndpoint', function(error, webRtcEndpoint) {
		...
		webRtcEndpoint.processOffer(sdpOffer, function(error, sdpAnswer) {
			...
			presenter.filter.connect(webRtcEndpoint, function(error) {
				if (error) {
					stop(sessionId);
					return callback(error);
				}
